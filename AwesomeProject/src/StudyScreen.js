    ...
    <Card style={styles.itemCard}>
      <Card.Content style={styles.cardView}>
        <View style={styles.view1}>
          <Card.Content style={{ backgroundColor: 'white', borderRadius: 15, borderWidth: 1, borderColor: '#FF7A00', padding: 5 }}>
            <Text style={styles.title}  variant="bodyMedium">{location}</Text>
            <Text   variant="bodyMedium">{idCourse}</Text>
        ...
        <View style={styles.view1}>
          ...
          <Text variant="bodyMedium">{nameCourse}</Text>
        </View>
      </Card.Content>
    </Card>
  </View>
